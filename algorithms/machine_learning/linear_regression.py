...
'''
    ...
    with col_input:
        ...
        input_weight = st.number_input("True Weight", value=2.5, step=0.1, key="lr_weight")
        
        st.write("**Input 2: True Bias**")
        input_bias = st.number_input("True Bias", value=3.0, step=0.1, key="lr_bias")
        
        st.write("**Input 3: Learning Rate**")
        input_lr = st.number_input("Learning Rate", value=0.01, step=0.001, format="%.3f", key="lr_rate")
