...
'''
    ...
    with col_input:
        ...
        input_samples = st.number_input("Samples per class", value=20, min_value=5, max_value=50, step=5, key="knn_samples")
        
        st.write("**Input 2: K value**")
        input_k = st.number_input("K value", value=3, min_value=1, max_value=10, step=1, key="knn_k")
        
        st.write("**Input 3: Prediction point X coordinate**")
        input_x = st.number_input("X coordinate", value=4.0, step=0.5, key="knn_x")
        
        st.write("**Input 4: Prediction point Y coordinate**")
        input_y = st.number_input("Y coordinate", value=4.0, step=0.5, key="knn_y")
