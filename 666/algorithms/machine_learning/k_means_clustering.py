...
'''
    ...
    with col_input:
        ...
        input_cluster1 = st.number_input("", value=100, min_value=50, max_value=200, step=10, key="kmeans_cluster1")
        
        st.write("**Input 2: Cluster 2 Sample Count**")
        input_cluster2 = st.number_input("", value=100, min_value=50, max_value=200, step=10, key="kmeans_cluster2")
        
        st.write("**Input 3: Cluster 3 Sample Count**")
        input_cluster3 = st.number_input("", value=100, min_value=50, max_value=200, step=10, key="kmeans_cluster3")
