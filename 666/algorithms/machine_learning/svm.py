...
'''
    ...
    with col_input:
        ...
        input_class1 = st.number_input("", value=100, min_value=50, max_value=200, step=10, key="svm_class1")
        
        st.write("**Input 2: Class 0 Sample Count**")
        input_class2 = st.number_input("", value=100, min_value=50, max_value=200, step=10, key="svm_class2")
        
        st.write("**Input 3: Regularization Parameter**")
        input_lambda = st.slider("", 0.001, 0.1, 0.01, step=0.001, key="svm_lambda")
